...
public class Constants
{
    ...
    public readonly static string iOSAppName = "com.companyname.Sentry.CrashReporter";
    public readonly static string AndroidAppName = "com.companyname.Sentry.CrashReporter";
